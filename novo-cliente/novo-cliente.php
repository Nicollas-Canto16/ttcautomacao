...
<body>
  <header
    ...
    <div class="row p-2">
      ...
      <div class="col d-flex justify-content-end align-items-center pe-5">
        ...
        <a class="rounded-4 p-2 d-flex a" href="">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="30"
            height="30"
  ...
  <main class="container-fluid p-5">
    <div class="row d-flex pb-5">
      <div class="d-flex">
        <div class="pt-2 pe-2">
          <a class="border border-2 rounded-3 p-1 d-flex btnVoltar" href="">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
              ...
              stroke-linecap="round"
              stroke-linejoin="round"
              class="lucide lucide-chevron-left-icon lucide-chevron-left icon">
    ...
    <form class="" id="client_os_form" action="./envio_dados.php" method="post">
      ...
      <div class="row border border-2 p-3 rounded-4">
        ...
        <div class="pb-3">
          <label for="osDescripition" class="form-label">Descrição da ordem de serviço*</label>
          <textarea
            class="form-control"
            id="osDescripition"
            name="osDescripition"
